...
Route::post('/works/{work}/feedback', 'FeedbackController@store')->name('works.feedbacks.store')->middleware('permission:works.feedbacks.create');
Route::delete('/works/{work}/feedback/{feedback}', 'FeedbackController@destroy')->name('works.feedbacks.destroy')->middleware('permission:works.feedbacks.destroy');
